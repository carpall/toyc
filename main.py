import utils, data, xlexer, preprocessor
...
init_plugins(utils_module=utils, data_module=data, lexer_module=xlexer, preprocessor_module=preprocessor)
...
# parser_result = Parser(source_info, preprocessor_result).gen()